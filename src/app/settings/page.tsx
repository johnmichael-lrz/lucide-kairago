...
function ListenBulletinButton(props: {
  ...
  return (
    <button
      ...
      aria-label={isSpeakingBulletin ? "Speaking recommended action" : "Listen to bulletin"}
      className={cn(
              ...
              <div className="relative mt-4 overflow-hidden rounded-r-xl border-l-4 border-[var(--golden-yellow)] bg-[var(--surface)]">
                ...
                <div className="relative space-y-4 p-5">
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0 space-y-1">
                      <span className="block text-[11px] font-medium tracking-[0.1em] text-[var(--text-muted)]">STATUS</span>
                      <h2 className="text-[28px] font-extrabold leading-[1.1] text-[var(--golden-yellow)]">
                        MODERATE RISK
                      </h2>
                    </div>
                ...
                <div className="relative space-y-4 p-5">
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0 space-y-2">
                      <span className="block text-[11px] font-medium tracking-[0.1em] text-[var(--text-muted)]">STATUS</span>
                      <h2 className="text-[28px] font-extrabold leading-[1.1] text-[var(--terracotta)]">
                        EVACUATE NOW
                      </h2>
